...
export const metadata = {
  ...
  description:
    "Review Notexia's Terms of Service and User Agreement. Learn account rules, acceptable conduct, intellectual property rights, coin economy, and platform terms.",
};
          ...
          <section className="rounded-[2rem] bg-[#1A2D23]/90 border border-[#F3F0E4]/15 p-2 shadow-xl">
            <div className="rounded-[calc(2rem-0.5rem)] bg-[#121F18] p-6 sm:p-8 space-y-4">
              ...
              <p className="text-[#9FAEA1] font-light">
                ...
                <Link href="/legal/refund-policy" className="text-[#8FC3DE] font-bold hover:underline">
                  Refund Policy
                </Link>
                .
              </p>
