...
export const metadata: Metadata = {
  ...
  description:
    "Browse verified student study notes, research papers, and technical articles on Notexia. Explore formula sheets, code blueprints, and peer insights.",
  alternates: { canonical: "https://notexia.in/feed" },
  openGraph: {
    title: "Public Study Notes, Research Papers & Academic Articles | Notexia",
    description:
      "Browse verified student study notes, research papers, and technical articles on Notexia.",
