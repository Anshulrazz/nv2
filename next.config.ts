...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "frame-src 'self' https://checkout.razorpay.com https://*.razorpay.com https://*.razorpay.in https://api.razorpay.com https://accounts.google.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.googlesyndication.com https://*.doubleclick.net https://tpc.googlesyndication.com https://www.google.com https://*.google.com https://*.googleadservices.com",
      "object-src 'self'",
